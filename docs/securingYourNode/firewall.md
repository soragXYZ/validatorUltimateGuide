In general, your machine should only accept network traffic on ports that your node use. To enforce that and prevent any unexpected or undesirable traffic, we can install a **firewall** on the node.
